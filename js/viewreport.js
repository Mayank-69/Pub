...
(function(){
  ...
  var projname,email,video,presentation,report;
  ...
  {
    firebase.firestore().collection("Student Portfolio").where("email","==",email).onSnapshot(function(querySnapshot) {
        var cities = [];
        var cities1 = [];
       ...
       console.log("lalalalalala");
            ...
            cities.push(doc.data().report);
            cities1.push(doc.data().projectname);
          ...
          document.getElementById("proj").innerHTML=cities1;
                document.getElementById("report").innerHTML=cities;
