...
(function(){
  ...
  function m()
  {
    ...
    var docRef = db.collection("authenticatedUsers").doc(emailId.value);
...
docRef.get().then(function(doc) {
    if (doc.exists) {
      ...
      var docRef12 = firebase.firestore().collection("recruiters").doc(emailId.value);
  ...
  function m1()
  {
    ...
    console.log("m1() k andar aaya");
    var db = firebase.firestore();
    var docRef = db.collection("recruiters").doc(recEmailId.value);
...
docRef.get().then(function(doc) {
    ...
    count = 1;
      ...
      var docRef123 = firebase.firestore().collection("authenticatedUsers").doc(recEmailId.value);
